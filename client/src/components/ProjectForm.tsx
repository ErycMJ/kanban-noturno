...
import type { CreateProjectDto, Column } from '../types/project';
...
const ProjectForm: React.FC<ProjectFormProps> = ({ onSubmit, onCancel, columns }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (form.name.trim() && form.responsible.trim()) {
      onSubmit(form);
    }
  };
